...
1. 项目目录下创建 mock 文件夹，添加 db.json 文件      
    ...
    <img src="https://raw.githubusercontent.com/Selenamona/Selenamona.github.io/master/assets/img/posts/mock3.jpg" width="700"/>

2. build/dev-server.js 中添加如下代码   

    <img src="https://raw.githubusercontent.com/Selenamona/Selenamona.github.io/master/assets/img/posts/mock1.jpg" width="700"/>

3. npm run dev 启动后，可以通过 http://localhost:项目端口号/mock/db.json 访问数据，proxyTable对应设置代理即可（代理设置方法与解决跨域方法相似）

    <img src="https://raw.githubusercontent.com/Selenamona/Selenamona.github.io/master/assets/img/posts/mock2.jpg" width="400"/>
...
1. 执行$ npm run mock 命令，运行 mock server
    ...
    <img src="https://raw.githubusercontent.com/Selenamona/Selenamona.github.io/master/assets/img/posts/mock4.jpg" width="700"/>


2. 访问 http://localhost:3000/    

    <img src="https://raw.githubusercontent.com/Selenamona/Selenamona.github.io/master/assets/img/posts/mock5.jpg" width="700"/>
...
<img src="https://raw.githubusercontent.com/Selenamona/Selenamona.github.io/master/assets/img/posts/mock6.png" width="700"/>
